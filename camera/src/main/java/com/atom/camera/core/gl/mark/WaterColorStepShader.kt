package com.atom.camera.core.gl.mark
...
class WaterColorStepShader : BaseShader {
    ...
    constructor(res: Resources) : super(res, "shader/base.vert", "shader/effect/water_color_step1.frag"){
