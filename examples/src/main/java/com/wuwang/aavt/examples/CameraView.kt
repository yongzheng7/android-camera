...
class CameraView : TextureView, SurfaceTextureListener, Renderer {
    ...
    // filter
    // 滤镜系统
    private var mCurrentFilterIndex // 当前滤镜
            : Int = 0
    private var mFilter // 基础滤镜
            : GroupFilter? = null
    ...
    override fun sizeChanged(width: Int, height: Int) {
        ...
        MatrixUtils.flip(mFilter!!.vertexMatrix, false, true)
    }
    ...
    override fun onSurfaceTextureAvailable(surface: SurfaceTexture, width: Int, height: Int) {
        Log.e("CameraView" ,"onSurfaceTextureAvailable > $width > $height")
        mCamera = Camera.open(mCurrentCameraId)
    ...
    override fun onSurfaceTextureSizeChanged(p0: SurfaceTexture, width: Int, height: Int) {
        Log.e("CameraView" ,"onSurfaceTextureSizeChanged > $width > $height")
        cameraRecorder?.setPreviewSize(width, height)
    }
